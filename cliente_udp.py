...
def main():
    ...
    while True:
        ...
        mensagem = funcoes_aux.criar_requisicao(int(tipo), funcoes_aux.sortear_identificador()) # Cria a mensagem a ser passada para o servidor de acordo com a requisão
